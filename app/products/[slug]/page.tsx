...
export default function ProductPage({
   ...
   * Gallery images
   *
   * If your product object already has an `images` array,
   * those images will be used.
   *
   * Otherwise the main product.image will be used as fallback.
   */
const productImages =
        ...
        <div className="container">
          ...
          <div className="product-layout">
            ...
            <div className="product-info" data-reveal>
              ...
              <p className="material-full">
                {product.materialLong}
              </p>
              ...
              >
                <strong>
                  Available sizes, colours &amp; finishes
                </strong>{" "}
                — this photo shows the standard{" "}
                {product.size} panel. Other sizes, colours
                and finishes may be available. Ask on
                WhatsApp for the current options and
                warranty terms.
              </div>
              ...
              >
                ...
                <strong>
                  Send us a photo of your existing
                  door/opening →
                </strong>
              </a>
              ...
              <div className="product-note">
                Product photo sourced from the
                manufacturer&apos;s catalogue. Finish and
                colour may vary slightly from the physical
                sample. Visit the showroom to confirm
                before ordering.
              </div>
